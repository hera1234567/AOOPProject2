...
public class TowerDefenceLevel {
    ...
    public TowerDefenceLevel(int height, int width, boolean[][] passable,
        ...
        this.startCol = targetCol;
        this.passable = passable;

    }

    public int getHeight() { //height of boolean

        return height; }

    public int getWidth() { //width of boolean

        return width; }

    public Position getPosition(int row, int col) { //get what is at column and row
        Position position = new Position(row,col);
        return position; }

    public boolean[][] getpassable() { return passable; } //is the step true
